...
public class JdbcUserDao implements UserDao {
    ...
    public User saveUser(String userName, String password, String role) {
        ...
        long newId = jdbcTemplate.queryForObject(
                "INSERT INTO users(user_name, password, salt, role) VALUES (?, ?, ?, ?) RETURNING id", Long.class,
    ...
    public List<User> getAllUsers() {
        ...
        String sqlSelectAllUsers = "SELECT id, user_name, role FROM users";
    ...
    public User getUserByUsername(String username) {
        String sqlSelectUserByUsername = "SELECT id, user_name, role FROM users WHERE user_name = ?";
